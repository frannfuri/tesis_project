...
from features.binarization_methods import numpy_to_str_sequence, median_bin
...
if __name__ == '__main__':
    ...
    axs3[0,0].plot(y_chirp_lzcs, '-o', label='LZC vs freq.', linewidth=0.6, markersize=1)
    axs3[0,0].legend(loc='upper right', fontsize=7)
    axs3[0,0].set_ylim((0.1, 0.2))
    axs3[0,1].plot(y_four_comp_lzcs, '-o', label='LZC vs numb. of freq. components', linewidth=0.6, markersize=1)
    axs3[0, 1].legend(loc='upper right', fontsize=7)
    axs3[0, 1].set_ylim((0, 0.2))
    axs3[0, 2].plot(y_am_chirp_lzcs, '-o', label='LZC vs amplitude', linewidth=0.6, markersize=1)
    axs3[0, 2].legend(loc='upper right', fontsize=7)
    axs3[0, 2].set_ylim((0.1, 0.2))
    axs3[1, 0].plot(y_increm_snr_lzcs, '-o', label='LZC vs SNR', linewidth=0.6, markersize=1)
    axs3[1, 0].legend(loc='upper right', fontsize=7)
    axs3[1, 0].set_ylim((0, 0.8))
    axs3[1, 1].plot(y_increm_power_noise_lzcs, '-o', label='LZC vs power noise', linewidth=0.6, markersize=1)
    axs3[1, 1].legend(loc='upper right', fontsize=7)
    axs3[1, 1].set_ylim((0, 2))
    axs3[1, 2].plot(y_variable_bw_noise_lzcs, '-o', label='LZC vs noise bandwidth', linewidth=0.6, markersize=1)
    axs3[1, 2].legend(loc='upper right', fontsize=7)
    axs3[1, 2].set_ylim((0.1, 0.6))
    axs3[1,1].set_xlabel('window in time')
    axs3[1, 2].set_xlabel('window in time')
    plt.show()
    a = 1
    a = 0